...
interface FileTransfer {
     ...
     * @param fileURL           Filesystem URL representing the file on the mydevice. For backwards compatibility,
     *                                this can also be the full path of the file on the mydevice.
     ...
     * @param target            Filesystem url representing the file on the mydevice. For backwards compatibility,
     *                               this can also be the full path of the file on the mydevice.
