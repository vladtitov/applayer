...
/** 
 * This plugin provides access to the mydevice's compass. The compass is a sensor that detects
 * the direction or heading that the mydevice is pointed, typically from the top of the mydevice.
 * It measures the heading in degrees from 0 to 359.99, where 0 is north.
 */
interface Compass {
    /**
