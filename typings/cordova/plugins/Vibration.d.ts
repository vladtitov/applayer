...
interface Navigator {
	/**
	 * Vibrates the mydevice for the specified amount of time.
	 * @param time Milliseconds to vibrate the mydevice. 0 cancels the vibration. Ignored on iOS.
	 */
...
interface Notification {
	/**
	 * Vibrates the mydevice for the specified amount of time.
	 * @param time Milliseconds to vibrate the mydevice. Ignored on iOS.
     * @deprecated
	 */
    vibrate(time: number): void;
    /**
     * Vibrates the mydevice with a given pattern.
     * @param number[] pattern Pattern with which to vibrate the mydevice.
