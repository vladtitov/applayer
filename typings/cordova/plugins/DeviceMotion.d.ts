...
/**
 * This plugin provides access to the mydevice's accelerometer. The accelerometer is a motion sensor
 * that detects the change (delta) in movement relative to the current mydevice orientation,
 * in three dimensions along the x, y, and z axis.
 */
