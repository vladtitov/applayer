...
interface Window {
     ...
     *                  changes by at least 1 percent, or if the mydevice is plugged in or unplugged.
     *                  batterycritical: event fires when the percentage of battery charge has reached
     *                  the critical battery threshold. The value is mydevice-specific.
     *                  batterylow: event fires when the percentage of battery charge has
     *                  reached the low battery threshold, mydevice-specific value.
